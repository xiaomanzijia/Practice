...
import me.student.greendao.DaoMaster;
import me.student.greendao.DaoSession;
...
public class StudentActivity extends ListActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        String textColumn = StudentDao.Properties.Name.columnName;
        String orderBy = textColumn + " COLLATE LOCALIZED ASC";
        cursor = db.query(getStudentDao().getTablename(), getStudentDao().getAllColumns(), null, null, null, null, orderBy);
        String[] from = {textColumn, StudentDao.Properties.Name.columnName};
    ...
    private void addNote() {
        ...
        Student student = new Student(null, comment, true, 10f, new Date(), new Date());
        getStudentDao().insert(student);
        Log.d(TAG, "Inserted new note, ID: " + student.getId());
        cursor.requery();
    }
    ...
    private void search() {
        ...
        Query query = getStudentDao().queryBuilder()
                .where(StudentDao.Properties.Name.eq("Test1"))
...
//      List notes = query.list();
    ...
    protected void onListItemClick(ListView l, View v, int position, long id) {
        ...
        getStudentDao().deleteByKey(id);
//        getStudentDao().deleteAll();
