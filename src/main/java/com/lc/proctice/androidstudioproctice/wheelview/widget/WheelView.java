...
import com.lc.proctice.androidstudioproctice.wheelview.widget.adapters.WheelViewAdapter;
...
public class WheelView extends View {
	...
	private static final int[] SHADOWS_COLORS = new int[] { 0xefE9E9E9,
			0x9fE9E9E9, 0x3fE9E9E9 };
